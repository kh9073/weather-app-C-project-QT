    ...
    , ui(new Ui::MainWindow)
{
    ...
    this->setWindowTitle("Weather Forecasting");
...
void MainWindow::displayForecast(int _index)
{
    if(_index < days.size()){
        ...
        if(days.at(_index).icon == "snow" || days.at(_index).icon == "snow-showers-day" ||
            ...
            ui->gif->setMask((new QPixmap("C:/Users/HP/Downloads/Weatheron-main/Weatheron-main/Compiled/release/weather-animations/snow.gif"))->mask());
            QMovie *movie = new QMovie("C:/Users/HP/Downloads/Weatheron-main/Weatheron-main/Compiled/release/weather-animations/snow.gif");
            ui->gif->setMovie(movie);
            movie->start();
            ...
            ui->gif->setMask((new QPixmap("C:/Users/HP/Downloads/Weatheron-main/Weatheron-main/Compiled/release/weather-animations/thunderstorm.gif"))->mask());
            QMovie *movie = new QMovie("C:/Users/HP/Downloads/Weatheron-main/Weatheron-main/Compiled/release/weather-animations/thunderstorm.gif");
            ui->gif->setMovie(movie);
            movie->start();
            changeFontColor("white");
        }
            ...
            ui->gif->setMask((new QPixmap("C:/Users/HP/Downloads/Weatheron-main/Weatheron-main/Compiled/release/weather-animations/rain.gif"))->mask());
            QMovie *movie = new QMovie("C:/Users/HP/Downloads/Weatheron-main/Weatheron-main/Compiled/release/weather-animations/rain.gif");
            ui->gif->setMovie(movie);
            movie->start();
            changeFontColor("white");
        }
        else if(days.at(_index).icon == "fog"){
            ui->gif->setMask((new QPixmap("C:/Users/HP/Downloads/Weatheron-main/Weatheron-main/Compiled/release/weather-animations/fog.gif"))->mask());
            QMovie *movie = new QMovie("C:/Users/HP/Downloads/Weatheron-main/Weatheron-main/Compiled/release/weather-animations/fog.gif");
            ui->gif->setMovie(movie);
            movie->start();
            changeFontColor("white");
        }
            ...
            ui->gif->setMask((new QPixmap("C:/Users/HP/Downloads/Weatheron-main/Weatheron-main/Compiled/release/weather-animations/clouds.gif"))->mask());
            QMovie *movie = new QMovie("C:/Users/HP/Downloads/Weatheron-main/Weatheron-main/Compiled/release/weather-animations/clouds.gif");
            ui->gif->setMovie(movie);
            movie->start();
            changeFontColor("white");
        }
            ...
            ui->gif->setMask((new QPixmap("C:/Users/HP/Downloads/Weatheron-main/Weatheron-main/Compiled/release/weather-animations/clear.gif"))->mask());
            QMovie *movie = new QMovie("C:/Users/HP/Downloads/Weatheron-main/Weatheron-main/Compiled/release/weather-animations/clear.gif");
            ui->gif->setMovie(movie);
            movie->start();
            changeFontColor("black");
        }
